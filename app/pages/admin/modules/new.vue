  ...
  <div class="container mx-auto h-full pt-5 px-5">
    <div class="flex flex-col h-full">
      <div class="">
        ...
        <h1 class="text-2xl font-bold">Crear Módulo</h1>
      </div>

      <Alert
        v-if="showModuloError"
        variant="error"
...
<script setup>
  ...
  const { mutate, asyncStatus } = useMutation({
    ...
    onError: (error) => {
      errorMessage.value =
        error.data?.message || "Error al crear el modulo. Intenta de nuevo.";
