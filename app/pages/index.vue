<template>
  <div class="text-center h-dvh px-6 bg-white" vaul-drawer-wrapper>
    ...
    >
      <section
        class="flex gap-7 flex-col items-center justify-center lg:border-r lg:border-neutral-200 lg:h-full"
      >
        <img
          src="~/assets/svg/compdes-logo.svg"
          alt="COMPDES Logo"
      ...
      <section
        class="flex flex-col gap-8 lg:gap-18 items-center justify-center"
      >
        <Button class="lg:text-lg lg:py-8">
